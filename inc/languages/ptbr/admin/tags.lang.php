...
$l['setting_tags_droptable'] = 'Drop table?';//English
$l['setting_tags_droptable_desc'] = 'Do you want the "tags" table droped when you uninstall this plugin?';//English
$l['setting_tags_maxchars'] = 'Maximum tag length';//English
$l['setting_tags_maxchars_desc'] = 'Please enter the maximum length that a tag can have';//English
$l['setting_tags_minchars'] = 'Minimum tag length';//English
$l['setting_tags_minchars_desc'] = 'Please enter the minimum length that a tag can have';//English